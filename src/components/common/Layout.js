...
const DefaultLayout = ({ data, children, bodyClass, isHome }) => {
    ...
    const MainNavItems = require(`../../data/main-nav.json`)
        ...
        <>
            ...
            <div className="viewport">
                ...
                <div className="viewport-top">
                    ...
                    <header className="site-head" style={isHome ? { ...site.cover_image && { backgroundImage: `url(${site.cover_image})` } } : { backgroundImage: `url(/images/bg_single.png)` }}>
                                ...
                                <nav className="site-nav">
                                    {
                                        isHome ?
                                            <div className="site-nav-left">
                                                <MainNav data={MainNavItems} navClass="site-nav-item" />
                                            </div>
                                            :
                                            <div className="site-nav-left">
                                ...
                                </nav>
                                {
                                    isHome ?
                                        <div className="site-mast-right">
                                            <a className="site-nav-item" href="tel:" target="_blank" rel="noopener noreferrer"><img className="site-nav-icon" src="" alt="" />Call: (847) 268-4677</a>
                                        </div>
                                        :
                    ...
                    <footer className="site-foot">
                        <div className="site-foot-nav container">
                            <div className="site-foot-nav-left">
                                <Link to="/"><img style={{ width: 100 }} src={site.logo} alt={site.title} /> </Link>
                                {/* © {new Date().getFullYear()} */}
                            </div>
                            <span className="footer-moto"> &nbsp; {site.title} </span>
